...
- `startup-signals.test.ts` validates a sanitized three-scenario census supplied through `STATION_REAL_CODEX_STARTUP_CAPTURE`; see `docs/harness-startup.md`. It skips when no capture path is supplied.

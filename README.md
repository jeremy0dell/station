...
`v0.0.0-pre-alpha.14.5`, with one command:

```sh
curl --disable -fsSL https://github.com/jeremy0dell/station/releases/download/v0.0.0-pre-alpha.14.5/install.sh | sh
```
...
```text
Install experimental Station v0.0.0-pre-alpha.14.5 and validate setup on this machine.
...
Station `v0.0.0-pre-alpha.14.5` is an experimental pre-alpha. User-facing commands,

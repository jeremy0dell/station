...
`v0.0.0-pre-alpha.14.6`, with one command:
...
```text
Install experimental Station v0.0.0-pre-alpha.14.6 and validate setup on this machine.
...
Station `v0.0.0-pre-alpha.14.6` is an experimental pre-alpha. User-facing commands,

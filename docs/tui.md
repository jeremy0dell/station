...
- Canonical attachment identity prevents a renderer from attaching to the wrong PTY lifetime; it does not yet serialize write or resize authority between multiple correctly identified renderers.

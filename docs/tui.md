...
follow the caret horizontally and never wrap into the body. Editing and applied header rows reserve
one cell of horizontal inset on both sides so the filter surface does not touch the dashboard edges.

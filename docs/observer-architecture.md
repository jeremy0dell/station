...
| Duplicate-cleanup exclusion | Driven | `ObserverDuplicateCleanupExclusion` | boot-claim cleanup exclusion adapter | Final cleanup revalidation runs only under a fail-fast boot claim and releases it after every callback outcome. |

...
```text
Install experimental Station v0.0.0-pre-alpha.5.8 and validate setup on this machine.
...
```bash
curl --disable -fsSL https://github.com/jeremy0dell/station/releases/download/v0.0.0-pre-alpha.5.8/install.sh | sh
```

The released `install.sh` is stamped with `v0.0.0-pre-alpha.5.8`. With no
...
```bash
curl --disable -fsSL https://github.com/jeremy0dell/station/releases/download/v0.0.0-pre-alpha.5.8/install.sh | \

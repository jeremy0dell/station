...
```text
Install experimental Station v0.0.0-pre-alpha.3 and validate setup on this machine.

Safety and scope:
- Do not clone the repository or build from source. Use only
  `https://github.com/jeremy0dell/station/releases/download/v0.0.0-pre-alpha.3/install.sh`.
...
```bash
curl -fsSL https://github.com/jeremy0dell/station/releases/download/v0.0.0-pre-alpha.3/install.sh | sh
```

The released `install.sh` is stamped with `v0.0.0-pre-alpha.3`. With no
...
```bash
curl -fsSL https://github.com/jeremy0dell/station/releases/download/v0.0.0-pre-alpha.3/install.sh | \

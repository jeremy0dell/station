...
The released `install.sh` is stamped with `v0.0.0-pre-alpha.14.2`. With no
...
```bash
curl --disable -fsSL https://github.com/jeremy0dell/station/releases/download/v0.0.0-pre-alpha.14.2/install.sh | \

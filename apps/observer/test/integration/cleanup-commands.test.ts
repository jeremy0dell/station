...
describe("cleanup command handlers", () => {
  ...
  it("removes a session worktree when terminal cleanup finds an already-missing target", async () => {
    const fixture = createFixture({ state: "working", terminalCloseTargetMissing: true });
    await fixture.core.reconcile("pre-cleanup");

...
// the ../ depth is tied to this file's location under station/src/host/test/. Pin it to
// the repo root (four levels up) so a future move can't silently escape the worktree

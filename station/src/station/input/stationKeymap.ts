...
export const STATION_KEYMAP: Record<StationInputMode, readonly StationBinding[]> = {
  dashboard: [
    ...
    { id: "station.dashboard.remove", pattern: { kind: "char", char: "X" }, action: "station.remove.open", outcome: "handled", help: { keys: "X", label: "rm" } },
...
export const STATION_HELP_CONTENT = [
  ...
  { key: "N/A/R/X/C", description: "new/add/rename/remove/fold" },

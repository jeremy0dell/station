...
type TuiFolderEntry = Awaited<ReturnType<TuiFolderService["readDirectory"]>>["entries"][number];
type TuiFolderSearchResult = Awaited<ReturnType<TuiFolderService["searchDirectories"]>>;
...
/** Station-local Node filesystem policy for Add Project folder navigation. */

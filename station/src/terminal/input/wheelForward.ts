...
import { MouseWheelButton, sgrMouseReport } from "../protocol/mouse.js";
...
export function buildWheelForwardSequence(params: WheelForwardParams): string {
  if (params.mouseReporting) {
    ...
    // exists yet), so aim a single SGR wheel "press" at the viewport center in
    ...
    return sgrMouseReport(button, col, row, false);
  }
